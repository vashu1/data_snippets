...
CREATE TABLE IF NOT EXISTS Dim_Centres (
  Region varchar(450) NOT NULL,
  Centre_Id varchar(450) NOT NULL,
  Centre_Name varchar(450) NOT NULL
);

CREATE TABLE IF NOT EXISTS Map_Centre_Cust (
  Centre_Id varchar(450) NOT NULL,
  Cust_Id INT NOT NULL
);

CREATE TABLE IF NOT EXISTS Fact_Centre_Txn (
  Centre_Id varchar(450) NOT NULL,
  Cust_Id INT NOT NULL,
  Visit_Date timestamp without time zone,
  Transaction_Id varchar(450) NOT NULL,
